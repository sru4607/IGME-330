...
public:
	...
	*/
	...
	/*
	USAGE: Rotates the camera based on the angles
	ARGUMENTS: Two floats the angle to rotate the camera along the X axis, and the angle to rotate the camera along the Y axis
	OUTPUTE: ---
	*/
	void RotateCamera(float a_fAngleX = 0, float a_fAngleY = 0);
