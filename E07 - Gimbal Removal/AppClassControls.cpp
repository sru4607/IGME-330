...
#pragma endregion
	...
	//Should fix Gimbal Lock now that rotation is stored as a matrix
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::X))
	{
		...
		m_Rotation*= matrix3(1, 0, 0, 0, cos(angle), -sin(angle), 0, sin(angle), cos(angle));
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Y))
	{
		...
		m_Rotation*= matrix3(cos(angle),0,sin(angle), 0,1,0, -sin(angle),0, cos(angle));
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Z))
	{
		...
		m_Rotation *= matrix3(cos(angle), -sin(angle), 0, sin(angle), cos(angle),0,0,0,1);
	}
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::R))
	{
		m_Rotation = matrix3(1.0f);
	}
}
//Joystick
